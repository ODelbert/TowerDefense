    ...
    case TowerID_ForestKeeper:
        {
            ...
            // Layer1
            const char* format = imgIndex < 10 ? "barracks_towers_layer1_000%d.png" : imgIndex < 100 ? "barracks_towers_layer1_00%2d.png" : "barracks_towers_layer1_03d.png";
            ...
            if (TowerID_ForestKeeper != towerId) {
                // Layer2
                // 四个开门动画, 1->4, 26->29 ...
                const char* format2 = imgIndex < 10 ? "barracks_towers_layer2_000%d.png" : imgIndex < 100 ? "barracks_towers_layer2_00%2d.png" : "barracks_towers_layer2_03d.png";
