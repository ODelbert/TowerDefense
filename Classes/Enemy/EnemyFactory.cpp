...
Enemy* EnemyFactory::create(EnemyID id)
{
    switch (id) {
        ...
        ENEMY_FACTORY_CREATE(Tarantula)
        ENEMY_FACTORY_CREATE(TheBeheader)
        ENEMY_FACTORY_CREATE(Twilight_Avenger)
        ENEMY_FACTORY_CREATE(Twilight_Bannerbearer)
        ...
        ENEMY_FACTORY_CREATE(Arachnomancer_Mini)
